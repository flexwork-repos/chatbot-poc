...
• Only answer questions related to Flexwork’s services, features, pricing, training programs only if you have data otherwise reply with Sorry,I don't know.
...
`;
  ...
  try {
    const response = await fetch(`${process.env.baseUrl}/api/groq/chat`, {
      method: "POST",
